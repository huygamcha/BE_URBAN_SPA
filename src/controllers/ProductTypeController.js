...
const getDetailsProductType = async (req, res) => {
  try {
    ...
    const response = await ProductTypeService.getDetailsProductType(
      productTypeId
    );
    const { data, status, typeError, message, statusMessage } = response;
    return res.status(status).json({
...
const deleteManyProductType = async (req, res) => {
  try {
    ...
    const response = await ProductTypeService.deleteManyProductType(ids);
    const { data, status, typeError, message, statusMessage } = response;
    return res.status(status).json({
      typeError,
      data,
...
const getAllProductType = async (req, res) => {
  try {
    ...
    const response = await ProductTypeService.getAllProductType(params);
    const { data, status, typeError, message, statusMessage } = response;
    return res.status(status).json({
      typeError,
      data,
