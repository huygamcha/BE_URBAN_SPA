...
const createAppointment = async (req, res) => {
  try {
    const requiredFields = validateRequiredInput(req.body, ["customerName", "customerPhone", "serviceId", "appointmentDate"]);
...
const updateAppointment = async (req, res) => {
  try {
    ...
    const response = await AppointmentService.updateAppointment(appointmentId, req.body);
    const { data, status, typeError, message, statusMessage } = response;
    return res.status(status).json({
      typeError,
      data,
