...
const replyComment = async (req, res) => {
  try {
    ...
    const response = await CommentService.replyComment(req.body);
    const { data, status, typeError, message, statusMessage } = response;
    return res.status(status).json({
      typeError,
      data,
  ...
  try {
    ...
    if (!commentId) {
      return res.status(CONFIG_MESSAGE_ERRORS.INVALID.status).json({
        status: "Error",
        typeError: CONFIG_MESSAGE_ERRORS.INVALID.type,
        message: `The field commentId is required`,
      });
    }
...
const getDetailsComment = async (req, res) => {
  try {
    ...
    const response = await CommentService.getDetailsComment(reviewId);
    const { data, status, typeError, message, statusMessage } = response;
    return res.status(status).json({
      typeError,
      data,
...
const deleteMyComment = async (req, res) => {
  try {
    ...
    const response = await CommentService.deleteMyComment(commentId, userId);
    const { data, status, typeError, message, statusMessage } = response;
    return res.status(status).json({
      typeError,
      data,
  ...
  try {
    ...
    if (!ids || !ids.length) {
      return res.status(CONFIG_MESSAGE_ERRORS.INVALID.status).json({
        status: "Error",
        typeError: CONFIG_MESSAGE_ERRORS.INVALID.type,
        message: `The field commentIds is required`,
        data: null,
      });
    }
...
const getAllComment = async (req, res) => {
  try {
    ...
    const response = await CommentService.getAllComment(params);
    const { data, status, typeError, message, statusMessage } = response;
    return res.status(status).json({
      typeError,
      data,
...
const getAllCommentPublic = async (req, res) => {
  try {
    const params = req.query;
    const response = await CommentService.getAllCommentPublic(params);
    const { data, status, typeError, message, statusMessage } = response;
    return res.status(status).json({
      typeError,
      data,
...
const updateMyComment = async (req, res) => {
  try {
    ...
    const response = await CommentService.updateMyComment(
      commentId,
      userId,
      req.body
    );
